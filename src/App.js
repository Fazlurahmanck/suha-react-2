...
function MyComponent() {
  ...
  return (
    <>
          ...
          <div className="content">
            ...
            <div className="left">
              ...
              <div className="cta-group">
                ...
                <div className="phone">📞 <a href="#">85 90 33 84 99</a></div>
              </div>
            ...
            <div className="right">
              <div className="image-wrap">
                <img src="/images/men png.png" alt="Student" />
              </div>
            </div>
      ...
      <section className="course-section" id="course">
        ...
        <div className="course-container">
          ...
          <div className="course-card">
            ...
            <a href="https://wa.me/918590338499" className="see-more">
              Chat on WhatsApp
            </a>
          </div>
          ...
          <div className="course-card">
            ...
            <div className="course-info">
              <p><i className="fa-regular fa-clock"></i> Duration: <strong>4 Months</strong></p>
              <p>💼 100% Placement Assistance</p>
            </div>
            <a href="https://wa.me/918590338499?text=Artificial%20Intelligence%20(AI)" className="see-more">
              Chat on WhatsApp
          ...
          <div className="left">
            <div className="image-row">
              ...
              <div className="image-wrapper">
                <img src="/images/IMG_6686.JPG" alt="Training sessions" />
              </div>

              <div className="image-wrapper">
                <img src="images\WhatsApp Image 2025-05-05 at 13.00.15_327f202f.jpg" alt="Students learning" />
              </div>
      ...
      <section className="instagram-section" id="company">
        <div className="container">
          ...
          <div className="section-header">
            ...
            <p class="section-subtitle">Follow us on <a href="#" class="social-link">Instagram</a> for the latest updates
              and behind-the-scenes content. Stay connected with us and explore our latest projects and achievements.</p>
          </div>
          ...
          <div class="logos-section">
            <div class="section-header">
              <h3 class="section-title">Our Companies</h3>
              <p class="section-subtitle">Explore our diverse portfolio of businesses under the Suha Group umbrella</p>
            </div>

            <div class="logos-container">

              <div class="logo-box">
                <img src="grp_img\GOLD.jpg" alt="Suha Technology" />
              </div>
              <div class="logo-box">
                <img src="images\LOGOS\MEDICAL.jpg" alt="Suha Ventures" />
              </div>
              <div class="logo-box">
                <img src="images\LOGOS\DIGITECH.jpg" alt="Suha Education" />
              </div>
              <div class="logo-box">
                <img src="images\LOGOS\BULDING.jpg" alt="Suha Healthcare" />
              </div>
              <div class="logo-box">
                <img src="images\LOGOS\PHARMACY.jpg" alt="Suha Realty" />
              </div>
              <div class="logo-box">
                <img src="images\LOGOS\TYRE.jpg" alt="Suha Foundation" />
              </div>
            </div>
          </div>
      ...
      <section id="why-suha">
        <div class="container">
          <span class="section-label">Our Commitment to Excellence</span>
          <h2>Why Choose <span class="highlight">Suha Digitech</span> For Your IT Learning Journey</h2>

          <div class="features">
            <div class="feature-box">
              <img src="images\handshake-svgrepo-com (1).svg" alt="Placement Icon" />
              <h3>Career-Focused Support</h3>
              <p>Our placement team guides you with networking opportunities and interview training to help land your ideal
                job.</p>
            </div>
            ...
            <div class="feature-box">
              ...
              <p>Work closely with experienced mentors who bring deep insights from the tech industry into every session.
              </p>
            </div>
            ...
            <div class="feature-box">
              ...
              <p>Engage in practical tasks and capstone projects that reflect real-world industry requirements.</p>
            </div>

            <div class="feature-box">
              <img src="images\icons8-iso-50.png" alt="ISO Certified Icon" />
              <h3>International Standards</h3>
              <p>Suha Digitech is ISO 9001:2015 and 21001:2018 certified, ensuring quality in training standards, curriculum design, and student satisfaction in the field of IT education.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="footer-container">
          ...
          <div className="footer-left">
            <div className="logo-row">
              <img src="/images/LOGOS/LOGO 2.png" className="footer-logo" />
              <img src="/images/LOGOS/iso 9001 copy.png" alt="ISO Quality Logo" class="footer-logo-small" />
              <img src="images/LOGOS/WhatsApp Image 2025-05-24 at 11.55.50_e5bd1db6.png" alt="ISO Education Logo"
                class="footer-logo-small" />
              <img src="images/LOGOS/IAF.png" alt="IAF Logo" class="footer-logo-small" />
            </div>
          </div>
          ...
          <div className="footer-right">
            <h3>Contact</h3>
            <a href="https://www.instagram.com/suha.digitech/profilecard/?igsh=N2lyOWlvc3lrM2s3">
              <p>
